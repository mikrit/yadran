...
<div class="t-center">
	...
	<table class="t_form">
		...
		<tr>
			...
			<td><?=Form::input('registration_certificate_date', $data['registration_certificate_date'] != null ? date('Y-m-d', $data['registration_certificate_date']) : '', array('name' => 'date', 'class' => 'date_input'));?></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td><?=Form::input('registration_stage_date', $data['registration_stage_date'] != null ? date('Y-m-d', $data['registration_stage_date']) : '', array('name' => 'date', 'class' => 'date_input'));?></td>
		</tr>
		<tr>
